...
* **example_Dorphin.ipynb** ([here]("https://github.com/yusuke-imoto-lab/eps-attracting-basin/blob/main/example_Dorphin.ipynb")): An application exmaple pf ensemble weather forecast data for tropical cyclone (typhoon) ``Drophin'', generated by the Meso-scale Ensemble Prediction System (MEPS), provided by the Japan Meteorological Agency (JSA).
