...
<div style="text-align:left"><img style="width:100%; height: auto" src="https://github.com/yusuke-imoto-lab/eps-attracting-basin/blob/main/images/image_eps_attracting_basin.svg"/></div>
...
* **example_Dorphin.ipynb**: An application exmaple pf ensemble weather forecast data for tropical cyclone (typhoon) ``Drophin'', generated by the Meso-scale Ensemble Prediction System (MEPS), provided by the Japan Meteorological Agency (JSA).
